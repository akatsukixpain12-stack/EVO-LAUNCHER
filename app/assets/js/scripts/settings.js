...
/**
 * Bind a simple toggle card.
 * @param {string} toggleId Checkbox element id.
 * @param {string} statusId Status label element id.
 * @param {string} settingKey Key in perf settings object.
 * @param {string|null} sliderRowId Optional slider row to show/hide.
 */
